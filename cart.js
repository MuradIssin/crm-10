'use strict';
const rainbow = 'padding: 10px 5px; margin-bottom: 6px; border: 1px solid blue';
// ; text-shadow: 1px 1px 2px white,  0 0 0.8; color: orange';
...
const calculateItemPrice = () => {
  const newTotal = cart.items.reduce((acc, item) => item[1] + acc, 0);
  return newTotal;
};
